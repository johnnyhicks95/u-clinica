	...
	public function VerPerfilPacienteC(){
		...
		echo '<tr>
				...
				<td>
					...
					<a href="http://localhost:8080/u-clinica/perfil-P/'.$resultado["id"].'">
					...
					<div class="row">
						...
						<div class="col-md-6 col-xs-12">
							...
							if($resultado["foto"] != ""){
								...
								echo '<img src="http://localhost:8080/u-clinica/'.$resultado["foto"].'" width="200px" class="img-responsive">';

							}else {

								echo '<img src="http://localhost:8080/u-clinica/Vistas/img/defecto.png" width="200px" class="img-responsive">';
	...
	public function ActualizarPerfilPacienteC(){
		...
		if(isset($_POST["Pid"])){
			...
			$datosC = array("id"=>$_POST["Pid"], "nombre"=>$_POST["nombrePerfil"], "apellido"=>$_POST["apellidoPerfil"], 
			        "usuario"=>$_POST["usuarioPerfil"], "clave"=>$_POST["clavePerfil"], "documento"=>$_POST["documentoPerfil"], "foto"=>$rutaImg);
			...
			if($resultado == true){
				...
				window.location = "http://localhost:8080/u-clinica/perfil-P/'.$_SESSION["id"].'";
				</script>';
